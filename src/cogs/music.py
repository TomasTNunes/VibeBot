...
import json
import asyncio
from assets.logs.logger import music_logger as logger, music_data_logger
...
class MusicCog(commands.Cog):
    ...
    async def cog_app_command_error(self, interaction: discord.Interaction, error: app_commands.AppCommandError):
        ...
        if isinstance(error, app_commands.CheckFailure):
            ...
            # All CheckFailure exceptions should have already been individually handled, however this is added as a fail-safe.
            else:
